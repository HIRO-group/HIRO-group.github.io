...
Now, let's walk you through setting up ROS Melodic on your (virtual) machine. Note that ROS Melodic is only compatible with 18.04 LTS.
...
{% include image.html url="misc/turtle_spiral.png" max-width="50%" description="Turtle moving in a spiral" %}
