...
> — Fill out [this application](https://forms.gle/rDQzUZSr5ax8WMbS7) so we can get to know you a little better.
> — Write code to move a dummy robot in *turtlesim* (see below!).
> — Email <anuj.pasricha@colorado.edu> and set up a meeting to show him your final demo.
...
## Setting up ROS
If you're working with robots, you need to learn how to use Robot Operating System ([ROS](http://wiki.ros.org/ROS/Introduction)). Read the linked page to learn all about it!

Go through [this setup guide](https://www.notion.so/Setup-your-workstation-for-Sawyer-b55955b5f31a43f3acdccb73cf7e14bf) to install **ROS Melodic** (this version only works with 18.04 LTS) on your (virtual) machine. Everybody in the lab uses it. The setup guide also walks you through installing libraries for the Sawyer robot...which is probably the first robot you'll interact with should you choose to get your hands dirty. When you write code, you can use either C++ or Python. Make sure you test each bit of your code thoroughly. Make sure you commit to the lab Github often. And make sure you follow the [Google style guides](http://google.github.io/styleguide/) for the appropriate language.
...
{% include image.html url="misc/turtle_spiral.png" max-width="100%" description="Turtle moving in a spiral" %}
...
Send an email to **[Caleb Escobedo](mailto:caleb.escobedo@colorado.edu)**{:.color-banner} requesting access for our Google Sheets work log. Duplicate an existing tab in the worksheet and rename the tab. This is where you will be expected to log hours and tasks daily. We will pull up this log at our weekly meeting and go over a summary for each person's week.
